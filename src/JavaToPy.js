    ...
    return (
        <>
                ...
                <div id="Right-Nav">
                    <table>
                        <tr>
                            ...
                            <td>
                                <img onClick={() => {
                                    window.open("https://instagram.com/pranay_reddy_2112?igshid=YmMyMTA2M2Y=en", "_slef")
                                }
            ...
            <center>
                ...
                <div id="info">
                    <p> Dasari Pranay All Copyrights &copy; MALLAREDDY COLLEGE OF ENGINEERING AND TECHNOLOGY</p>
                </div>
            </center>
        </>
    )
